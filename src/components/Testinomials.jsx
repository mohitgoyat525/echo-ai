...
const Testinomials = () => {
  return (
    <div className="max-w-[1150px] mx-auto p-4 pt-[175px] max-lg:pt-32 max-md:pt-20 max-sm:pt-10">
            ...
            <div className="w-full min-w-[364px] max-sm:min-w-[320px] slider-bg-color rounded-t-3xl pt-6 px-6 pb-14 max-sm:pb-10">
              ...
              >
                ...
                <div className="flex flex-col">
                  ...
                  <p className="text-white font-medium text-xl leading-6 max-sm:text-base">
                    {obj.userDesignation}
                  </p>
                </div>
              </div>
