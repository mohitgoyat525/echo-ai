...
const CustomFaq = () => {
  ...
  return (
    <div id="faq" className="container pt-[210px] max-xl:pt-[170px] max-lg:pt-24 max-md:pt-14 max-sm:pt-10">
      <div className="pb-[60px] max-lg:pb-10">
        <CustomHeading sectionHeading="FAQs" />
      </div>
      <div className="max-w-[1022px] flex flex-col gap-6 mx-auto">
        {FAQ_LIST.map((item, index) => (
          ...
          >
            <div
              className={`bg-off-black border border-solid  rounded-xl p-6 max-md:p-4 ${
                active === index
                  ? "border-transparent"
                  : "border-[#FFFFFF1A]"
              }`}
            >
              <button
                ...
                className="w-full flex justify-between max-sm:pb-5 items-center font-semibold text-xl text-white leading-custom-3xl max-md:text-base gap-3 text-start"
              >
                {item.heading}
                <span
                  className={`${
              ...
              <div
                ...
                <p className="text-base text-white pt-4 max-w-[950px]">
                  {item.description}
                </p>
              </div>
            </div>
